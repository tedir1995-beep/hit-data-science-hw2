...
2. **Classification:** As an error-analysis benchmark, can descriptive metadata identify whether a model is gated, and where do classifiers make false-positive and false-negative errors? Downloads are excluded because access restrictions may affect download activity.
...
- `reports/EXTREME_ERROR_ANALYSIS.csv` - individual analysis of all 50 observations in the top 5% of absolute regression errors.
